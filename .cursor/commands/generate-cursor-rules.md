...
### 🔴 RULE 4: FILE SIZE LIMIT (200 LINES MAX)
```typescript
// ❌ FORBIDDEN - Single 800-line file
// order/page.tsx (800 lines) ❌

// ✅ REQUIRED - Split into components
components/
├── DesignSelector.tsx      (150 lines)
├── PaintTypeSelector.tsx   (80 lines)
├── QuantitySelector.tsx    (120 lines)
...
- Is the file size under 200 lines?
